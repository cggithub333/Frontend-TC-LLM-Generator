    ...
    <article className="mx-auto max-w-4xl rounded-xl border border-border bg-background px-6 py-10 shadow-sm sm:px-10 sm:py-14 lg:px-14 lg:py-16">
      ...
      <div className="space-y-10 sm:space-y-14 text-[15px] leading-7 text-muted-foreground">
        ...
        <section id="acceptance" className="scroll-mt-24">
          ...
          <p>
            By accessing or using QuraEx (&ldquo;the Application&rdquo;),
        ...
        <section id="description" className="scroll-mt-24">
          ...
          <p>
            QuraEx is an AI-powered quality assurance platform that enables
        ...
        <section id="accounts" className="scroll-mt-24">
          ...
          <p>
            To use QuraEx, you must create an account by providing your
        ...
        <section id="acceptable-use" className="scroll-mt-24">
          ...
          <p>You agree not to use QuraEx to:</p>
          <ul className="mt-4 ml-5 list-disc space-y-2 marker:text-muted-foreground/40">
        ...
        <section id="intellectual-property" className="scroll-mt-24">
          ...
          <p>
            ...
            documentation, is the intellectual property of the QuraEx
        ...
        <section id="ai-generated-content" className="scroll-mt-24">
          ...
          <p>
            QuraEx uses third-party Large Language Model (LLM) APIs to
        ...
        <section id="limitation-of-liability" className="scroll-mt-24">
          ...
          <p>
            To the maximum extent permitted by applicable law, QuraEx and
        ...
        <section id="changes" className="scroll-mt-24">
          ...
          <p>
            ...
            email or through an in-app notice. Continued use of QuraEx
